...
class Stammdaten(db.Model):
  ...
  lat=db.Column(db.String(10),name='lat', unique=True, nullable=True)
  long=db.Column(db.String(10), name='long', unique=True, nullable=True)
  adresse = db.Column(db.String(50),name='Adresse', unique=False, nullable=True)
